...
public class MUserprofileDaoImpl implements MUserprofileDao{
	...
	public MUserprofile updateMUserprofile(MUserprofile mUserprofile, Integer userid) {
		jdbcTemplate.update(connection -> {
			...
			temp.setString(4, mUserprofile.getAvatarname());
			temp.setString(5, mUserprofile.getEmail());
			temp.setString(6, mUserprofile.getAddress());
			temp.setString(7, mUserprofile.getAlias());
			temp.setString(8, mUserprofile.getPhone());
			temp.setString(9, mUserprofile.getMobile());
			temp.setString(10, mUserprofile.getFax());
			temp.setString(11, mUserprofile.getCity());
			temp.setInt(12, mUserprofile.getTenantid());
			temp.setString(13, mUserprofile.getEmployeecode());
			temp.setString(14, mUserprofile.getUpdatedBy());
