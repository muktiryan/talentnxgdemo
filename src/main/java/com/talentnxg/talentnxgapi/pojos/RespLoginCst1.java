...
public class RespLoginCst1 {
	...
	public List<MModuleForMenu> getTabmenu() {
		return tabmenu;
	}


	public void setTabmenu(List<MModuleForMenu> tabmenu) {
